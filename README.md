...
Syntax Analysis – Checks code structure and builds parse trees.

Semantic Analysis – Ensures correct use of variables, types, and scope.

Code Generation – Converts MicroJava code into executable bytecode.

Virtual Machine Execution – Runs bytecode on a custom MicroJava VM.
