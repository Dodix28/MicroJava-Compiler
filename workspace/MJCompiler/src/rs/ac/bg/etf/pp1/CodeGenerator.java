...
public class CodeGenerator extends VisitorAdaptor {
	...
	//-------------------------------------------------------Statement-----------------------------
		...
		public void visit(PrintStmt printStatement) {
			...
			if(exprType.getKind() == Struct.Array) {
		        ...
		        Code.putFalseJump(Code.gt, 0); // Ako iterator >= dužina, izađi iz petlje
		        ...
		        Code.put(Code.add);
		        Code.put(Code.dup_x2); // Povećaj iterator na steku
	...
	public void visit(Range factor) {
		int numOfElem = factor.struct.getNumberOfFields();
	    ...
	    Code.putJump(startLoop); // Skok na početak petlje
	    Code.fixup(endLoop); // Popravljanje adrese za kraj petlje
